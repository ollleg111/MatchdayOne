...
public class StickerTextView extends StickerView{
    ...
    public View getMainView() {
     ...
     //   tv_main.setTextSize(22);
        ...
        tv_main.setBackgroundColor(Color.parseColor("#cc0725"));
        tv_main.setBackgroundDrawable(getResources().getDrawable(R.drawable.dotted_border_view));
