            ...
            if(view.getTag().equals("DraggableViewGroup")) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        scale_orgWidth = StickerView.this.getLayoutParams().width -15;
                        scale_orgHeight = StickerView.this.getLayoutParams().height - 15;
...
//            borderPaint.setPathEffect(new DashPathEffect(new float[]{8, 4}, 0));
